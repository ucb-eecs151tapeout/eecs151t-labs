...
Complete the [git bootcamp assignment](https://github.com/ucb-eecs151tapeout/eecs151t-lab1-git-basics) and make a PR (pull request) to the template repo adding your name to STUDENTS.md! Don't forget to submit the Gradescope assignment.
