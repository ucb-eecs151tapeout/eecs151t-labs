...
`generators/shadow-council/src/main/resources/vsrc/cores`
...
``generators/shadow-council/src/main/scala/MyFavoriteCoreBlackBox.scala``
...
**Step 4: Submit your `scala` directory on Gradescope and answer any questions there may be.**
